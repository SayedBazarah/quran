...
const TABLE_HEAD: TableHeadCellProps[] = [
  { id: 'name', label: 'الاسم' },
  { id: 'teachers', label: 'المدرسيين', width: 150 },
  { id: 'admins', label: 'الاداريين', width: 150 },
  { id: '', width: 88 },
];
    ...
    <>
      <DashboardContent>
        ...
        <RoleBasedGuard
          ...
          allowedRoles={[
            GlobalPermissionCode.ReadTeacher,
            GlobalPermissionCode.DeleteTeacher,
            GlobalPermissionCode.UpdateTeacher,
          ]}
          sx={{
            marginY: 'auto',
          }}
